...
export function DashboardFooter({ className }: DashboardFooterProps) {
  return (
    <footer className="w-full border-t mt-4 mb-4 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <nav className="flex flex-wrap justify-center gap-x-6 gap-y-1 mb-1 text-xs">
        ...
        <Separator orientation="vertical" />
        <a href="#" className="block text-sm text-muted-foreground hover:text-foreground transition-colors">Docs</a>
        <Separator orientation="vertical" />
